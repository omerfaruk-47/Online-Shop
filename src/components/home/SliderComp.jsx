    ...
    <div>
      <Slider {...settings}>
        <div className="!flex items-center bg-[#F6F6F6] px-6">
          <div>
            <div className="text-6xl font-bold">KİŞİYE ÖZEL TASARIMLAR</div>
        ...
        <div className="!flex items-center bg-[#F6F6F6] px-6">
          <div>
            <div className="text-6xl font-bold">ESKİMEYEN SADELİK</div>
            <div className="text-lg my-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Excepturi, consectetur. Soluta nesciunt voluptatem a repellendus
              blanditiis adipisci nisi sit facere ad et incidunt, recusandae
        ...
        <div className="!flex items-center bg-[#F6F6F6] px-6">
          <div>
            <div className="text-6xl font-bold">KONFOR VE ŞIKLIK SENİNLE</div>
            <div className="text-lg my-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Excepturi, consectetur. Soluta nesciunt voluptatem a repellendus
              blanditiis adipisci nisi sit facere ad et incidunt, recusandae
